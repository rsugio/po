...
public class ExportConfigurationWizardPage extends WizardExportResourcesPage implements Listener {
	...
	protected boolean executeExportOperation(FileSystemExportConfigurationOperation op) {
	...
	public boolean finish() {
		...
		saveWidgetValues();
		return executeExportOperation(new FileSystemExportConfigurationOperation(null, resourcesToExport, getDestinationValue(), this));
	}
