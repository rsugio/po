...
public class ExportPayloadWizard extends Wizard implements IExportWizard {
	private IStructuredSelection selection;
	private ExportPayloadWizardPage mainPage;
	public ExportPayloadWizard() {
	...
	public void addPages() {
		super.addPages();
		mainPage = new ExportPayloadWizardPage(selection);
		addPage(mainPage);
	}
