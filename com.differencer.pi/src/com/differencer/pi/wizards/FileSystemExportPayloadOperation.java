...
public class FileSystemExportPayloadOperation implements IRunnableWithProgress {
	private IPath path;
	private IProgressMonitor monitor;
	private PayloadExporter exporter = new PayloadExporter();
	...
	public FileSystemExportPayloadOperation(IResource res, String destinationPath, IOverwriteQuery overwriteImplementor) {
		super();
		resource = res;
		path = new Path(destinationPath);
		overwriteCallback = overwriteImplementor;
	}
	public FileSystemExportPayloadOperation(IResource res, List resources, String destinationPath, IOverwriteQuery overwriteImplementor) {
